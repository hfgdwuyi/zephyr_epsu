...
static const struct bsp_gpio_spec pinCfgDout[] = {
    ...
    BSP_GPIO_SPEC(GPIO_DEV_K, 7,  BSP_DOUT_FLAGS), /* UI-OUT(4) */
    BSP_GPIO_SPEC(GPIO_DEV_K, 7,  BSP_DOUT_FLAGS), /* UI-OUT(5) */
    BSP_GPIO_SPEC(GPIO_DEV_K, 7,  BSP_DOUT_FLAGS), /* UI-OUT(6) */
    BSP_GPIO_SPEC(GPIO_DEV_K, 7,  BSP_DOUT_FLAGS), /* UI-OUT(7) */
    BSP_GPIO_SPEC(GPIO_DEV_K, 7,  BSP_DOUT_FLAGS), /* UI-OUT(8) */
